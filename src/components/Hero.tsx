  ...
  return (
    <div className="w-full flex flex-col items-center justify-center px-4 mt-8">
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        {/* Seamless Premium Card Container with Flowing Animated Border */}
        <div className="relative rounded-[42px] p-[2px] overflow-hidden shadow-[0_20px_80px_-15px_rgba(0,0,0,0.1)]">
          
          {/* Rotating Gradient Flow Background */}
          <motion.div
          ...
          {/* Actual Card Content */}
          <div className="relative bg-white rounded-[40px] overflow-hidden flex flex-col lg:flex-row min-h-[600px] z-10 w-full h-full">
            
            {/* Left Content (Text) */}
            <div className="w-full lg:w-[55%] p-10 md:p-16 lg:p-20 relative z-20 flex flex-col justify-center bg-white">
              {/* Tag Pills */}
